...
@Entity
@Table(name = "yamlevent", schema = "yaml", 
...
public class EventEdu extends Audit implements Base, Serializable{
	...
	private ComponentEdu parent; // Component that creates the event
