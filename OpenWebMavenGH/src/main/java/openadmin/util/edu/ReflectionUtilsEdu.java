...
//import openadmin.util.model.Base;

public class ReflectionUtilsEdu {
	...
	public static Object newObjectById(Class<?> pClass, Number pId) throws InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException, RuntimeException, IntrospectionException {
		Object obj=createObject(pClass);
		setProperty(obj,"description",pId);
		return obj;
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			int a=sizeAnnotated(openadmin.model.log.LogEdu.class,"person");
			System.out.println("Size=" + a);
			myObj = ReflectionUtilsEdu.createObject("openadmin.model.control.User");
			ReflectionUtilsEdu.setProperty(myObj, "description", "tatia");
			...
			ReflectionUtilsEdu.setProperty(myObj, propsDesc, "dateBegin", localDate.now());
