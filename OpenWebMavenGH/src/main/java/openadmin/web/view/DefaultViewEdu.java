...
public class DefaultViewEdu extends ObjectAction implements Serializable, ViewFacadeEdu{
	...
	public void execute(LangTypeEdu pLang, Integer numberView, List<Action> lstAction) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException, ClassNotFoundException{
